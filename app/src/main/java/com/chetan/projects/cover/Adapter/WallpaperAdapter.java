...
public class WallpaperAdapter extends RecyclerView.Adapter<WallpaperAdapter.ImageViewHolder> {
    ...
    private final List<LoadedImageInfo> mImagesInfos;
    private final LayoutInflater mLayoutInflater;

    public WallpaperAdapter(Context context, List<LoadedImageInfo> imageInfos) {
        mContext = context;
        mLayoutInflater = LayoutInflater.from(context);
        mImagesInfos = imageInfos;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull WallpaperAdapter.ImageViewHolder imageViewHolder, int i) {
        imageViewHolder.mCurrentPosition = i;

        String url1 = mImagesInfos.get(i).getPreviewUrl();
        String url2 = mImagesInfos.get(i).getMediumImageUrl();
        ...
        public ImageViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra(WallpaperDetailActivity.SEND_IMAGE_INFO, mImagesInfos.get(mCurrentPosition).toString());
   ...
   /* public void addLargeImageUrls(List<String> imageUrls) {
        mlargeImageUrls.addAll(imageUrls);
    }

    public void addPreviewImageUrls(List<String> imageUrls) {
       mPreviewImageUrls.addAll(imageUrls);
    }*/
}
